...
while True: #keep going until manually stopped by condition
    ...
    if user_number_int == 9999: #If 9999 is entered, break program, otherwise keep running
        ...
        # -------------Final-Result-------------------------------------- #
        print(f"Your {user_number_int} sided die resulted in: {dice_roll}") #Gives original sided die and result
        print(f"Your results so far are: {user_results}\n") #Prints a tally of rolls by user
