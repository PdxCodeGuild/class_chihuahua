...
def num_to_phrase(num):
    ...
    if num < 10:
        ...
        if ones_digit == 0:
            ...
            return (f"{hundreds[hundreds_digit]} and {teen_words[teens_digit]}")
        else:
            return (f"{hundreds[hundreds_digit]} and {double_digit_words[tens_digit]} {single_digit_words[ones_digit]}")

print(num_to_phrase(177))
